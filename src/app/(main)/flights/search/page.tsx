...
function FlightResultsClientInternal() {
  ...
  if (error) {
    return (
      <div className="flex flex-col items-center justify-center min-h-screen p-4 text-center bg-white">
        ...
        <h2 className="text-2xl font-headline text-destructive-foreground mb-2">Oops! Something Went Wrong.</h2>
  ...
  if (currentFlightsToDisplay.length === 0 && !loading) {
    return (
      <div className="flex flex-col flex-1 bg-white text-foreground">
        <header ref={headerRef} className="bg-white text-foreground py-1 shadow-md sticky top-0 z-30 border-b border-border">
            <div className="max-w-screen-xl mx-auto px-4 space-y-1.5">
              <div className="max-w-6xl mx-auto">
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-8 gap-1 items-stretch">
                    <div className="rounded-md bg-muted/50 flex flex-col justify-between p-1 lg:px-1 lg:py-0.5">
                        <Label htmlFor="tripTypeHeader" className="text-xs text-muted-foreground block mb-0.5">TRIP TYPE</Label>
                        <Select value={formIsRoundTrip ? "roundTrip" : "oneWay"} onValueChange={(value) => setFormIsRoundTrip(value === "roundTrip")}>
                            <SelectTrigger id="tripTypeHeader" className="h-auto text-sm bg-transparent border-0 text-foreground focus:ring-0 focus:ring-offset-0 px-0 py-0.5 font-medium">
                    ...
                    <div className="rounded-md bg-muted/50 flex flex-col justify-between p-1 lg:px-1 lg:py-0.5">
                        <Label htmlFor="formOriginHeader" className="text-xs text-muted-foreground block mb-0.5">FROM</Label>
                        <Select value={formOrigin} onValueChange={setFormOrigin}>
                            <SelectTrigger id="formOriginHeader" className="h-auto text-sm bg-transparent border-0 text-foreground focus:ring-0 focus:ring-offset-0 px-0 py-0.5 font-medium truncate">
                    ...
                    <div className="flex items-center justify-center self-stretch">
                        <Button variant="ghost" size="icon" onClick={handleSwapLocations} className="h-7 w-7 text-muted-foreground hover:bg-muted hover:text-foreground rounded-full">
                            <ArrowRightLeft className="w-3.5 h-3.5" />
                        </Button>
                    </div>
                    <div className="rounded-md bg-muted/50 flex flex-col justify-between p-1 lg:px-1 lg:py-0.5">
                        <Label htmlFor="formDestinationHeader" className="text-xs text-muted-foreground block mb-0.5">TO</Label>
                         <Select value={formDestination} onValueChange={setFormDestination}>
                            <SelectTrigger id="formDestinationHeader" className="h-auto text-sm bg-transparent border-0 text-foreground focus:ring-0 focus:ring-offset-0 px-0 py-0.5 font-medium truncate">
                    ...
                    <div className="rounded-md bg-muted/50 flex flex-col justify-between p-1 lg:px-1 lg:py-0.5">
                        <Label className="text-xs text-muted-foreground block mb-0.5">DEPART</Label>
                        <Popover>
                            <PopoverTrigger asChild>
                                <Button variant="ghost" className="h-auto text-sm bg-transparent border-0 text-foreground hover:bg-transparent focus:ring-0 focus:ring-offset-0 px-0 py-0.5 w-full justify-start font-medium">
                                    <CalendarIconLucide className="mr-1.5 h-3.5 w-3.5 text-muted-foreground opacity-70 flex-shrink-0" />
                    ...
                    <div className={cn("rounded-md bg-muted/50 flex flex-col justify-between p-1 lg:px-1 lg:py-0.5", !formIsRoundTrip && "opacity-50")}>
                        <Label className="text-xs text-muted-foreground block mb-0.5">RETURN</Label>
                        <Popover>
                            <PopoverTrigger asChild disabled={!formIsRoundTrip}>
                                <Button variant="ghost" className="h-auto text-sm bg-transparent border-0 text-foreground hover:bg-transparent focus:ring-0 focus:ring-offset-0 px-0 py-0.5 w-full justify-start font-medium disabled:opacity-70">
                                    <CalendarIconLucide className="mr-1.5 h-3.5 w-3.5 text-muted-foreground opacity-70 flex-shrink-0" />
                                    <span className="truncate text-foreground">
                    ...
                    <div className="rounded-md bg-muted/50 flex flex-col justify-between p-1 lg:px-1 lg:py-0.5">
                        <Label className="text-xs text-muted-foreground block mb-0.5">PASSENGERS &amp; CLASS</Label>
                        <Popover open={passengerPopoverOpen} onOpenChange={setPassengerPopoverOpen}>
                            <PopoverTrigger asChild>
                                <Button variant="ghost" className="h-auto text-sm bg-transparent border-0 text-foreground hover:bg-transparent focus:ring-0 focus:ring-offset-0 px-0 py-0.5 w-full justify-start font-medium truncate">
                                    {passengerSummary}
                                </Button>
                            </PopoverTrigger>
                            <PopoverContent className="w-80 p-4 space-y-3">
                                <div className="text-lg font-semibold mb-2 text-foreground">Select Passengers &amp; Class</div>
                                <div className="space-y-1">
                                    <Label className="text-xs font-normal text-muted-foreground">Adults (12+ yrs)</Label>
                                ...
                                <div className="space-y-1">
                                    <Label className="text-xs font-normal text-muted-foreground">Children (2-12 yrs)</Label>
                                ...
                                <div className="space-y-1">
                                    <Label className="text-xs font-normal text-muted-foreground">Infants (0-2 yrs)</Label>
                                ...
                                <div className="space-y-1">
                                    <Label className="text-xs font-normal text-muted-foreground">Travel Class</Label>
                    ...
                    <Button 
                        onClick={handleHeaderSearch} 
                        className="bg-accent hover:bg-accent/90 text-accent-foreground font-bold rounded-lg h-full text-center leading-tight px-2 py-0.5 text-sm lg:px-2 lg:py-0.5"
                    >
                        SEARCH
                    </Button>
                </div>
        ...
        <div className="flex flex-col items-center justify-center flex-1 p-4 text-center">
            <Briefcase className="w-24 h-24 text-muted-foreground/70 mb-6" />
  ...
  return (
    <div className="flex flex-col flex-1 bg-slate-100">
      <header ref={headerRef} className="bg-white text-foreground py-1 shadow-md sticky top-0 z-30 border-b border-border">
            <div className="max-w-screen-xl mx-auto px-4 space-y-1.5">
              <div className="max-w-6xl mx-auto">
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-8 gap-1 items-stretch">
                    <div className="rounded-md bg-muted/50 flex flex-col justify-between p-1 lg:px-1 lg:py-0.5">
                        <Label htmlFor="tripTypeHeaderForm" className="text-xs text-muted-foreground block mb-0.5">TRIP TYPE</Label>
                        <Select value={formIsRoundTrip ? "roundTrip" : "oneWay"} onValueChange={(value) => setFormIsRoundTrip(value === "roundTrip")}>
                            <SelectTrigger id="tripTypeHeaderForm" className="h-auto text-sm bg-transparent border-0 text-foreground focus:ring-0 focus:ring-offset-0 px-0 py-0.5 font-medium">
                                <SelectValue />
                            </SelectTrigger>
                             <SelectContent>
                                <SelectItem value="oneWay">One Way</SelectItem>
                    ...
                    <div className="rounded-md bg-muted/50 flex flex-col justify-between p-1 lg:px-1 lg:py-0.5">
                        <Label htmlFor="formOriginHeaderForm" className="text-xs text-muted-foreground block mb-0.5">FROM</Label>
                        <Select value={formOrigin} onValueChange={setFormOrigin}>
                            <SelectTrigger id="formOriginHeaderForm" className="h-auto text-sm bg-transparent border-0 text-foreground focus:ring-0 focus:ring-offset-0 px-0 py-0.5 font-medium truncate">
                                <SelectValue />
                            </SelectTrigger>
                            <SelectContent>
                                {popularIndianAirports.map(airport => (
                    ...
                    <div className="rounded-md bg-muted/50 flex flex-col justify-between p-1 lg:px-1 lg:py-0.5">
                        <Label htmlFor="formDestinationHeaderForm" className="text-xs text-muted-foreground block mb-0.5">TO</Label>
                         <Select value={formDestination} onValueChange={setFormDestination}>
                            <SelectTrigger id="formDestinationHeaderForm" className="h-auto text-sm bg-transparent border-0 text-foreground focus:ring-0 focus:ring-offset-0 px-0 py-0.5 font-medium truncate">
                                <SelectValue />
                            </SelectTrigger>
                            <SelectContent>
                                {popularIndianAirports.map(airport => (
      ...
      <div className="max-w-screen-xl mx-auto p-4 md:p-6 flex flex-col lg:flex-row gap-6">
        ...
        > 
          <div className="bg-card shadow-lg border-border rounded-lg p-4 text-foreground">
                ...
                {["0", "1", "2+"].map((stopKey) => (
                  <div key={stopKey} className="flex items-center gap-2.5">
                    <Checkbox
                      ...
                      className="border-muted-foreground/50 data-[state=checked]:bg-primary data-[state=checked]:border-primary focus:ring-primary w-4 h-4 rounded"
                      aria-label={`Filter by ${stopKey === "0" ? "non-stop" : stopKey === "1" ? "1 stop" : "2+ stops"}`}
                    />
                    <label htmlFor={`stop-filter-${stopKey}`} className="text-sm font-medium text-foreground hover:text-foreground/80 transition-colors cursor-pointer">
            ...
            <Collapsible open={isDepartureAirportsOpen} onOpenChange={setIsDepartureAirportsOpen} className="mb-4">
                ...
                <CollapsibleContent className="space-y-2.5 mt-1 animate-slide-down">
                    <div className="flex items-center gap-2.5">
                        <Checkbox id="dep-airport-1" className="border-muted-foreground/50 data-[state=checked]:bg-primary data-[state=checked]:border-primary focus:ring-primary w-4 h-4 rounded"/>
                        <label htmlFor="dep-airport-1" className="text-sm font-medium text-foreground hover:text-foreground/80 transition-colors cursor-pointer">Hindon Airport (DZKm)</label>
                    </div>
                    <div className="flex items-center gap-2.5">
                        <Checkbox id="dep-airport-2" className="border-muted-foreground/50 data-[state=checked]:bg-primary data-[state=checked]:border-primary focus:ring-primary w-4 h-4 rounded"/>
                        <label htmlFor="dep-airport-2" className="text-sm font-medium text-foreground hover:text-foreground/80 transition-colors cursor-pointer">Indira Gandhi Intl Airport</label>
                    </div>
                </CollapsibleContent>
            </Collapsible>
            <Separator className="my-4 bg-border"/>
            <Collapsible open={isPriceOpen} onOpenChange={setIsPriceOpen} defaultOpen>
              ...
              <CollapsibleContent className="space-y-2.5 mt-3 animate-slide-down px-1">
                 <Slider
                    ...
                    className="[&>span:first-child]:bg-primary [&>span:first-child>span]:bg-card [&>span:first-child>span]:border-primary"
        ...
        <div className="lg:hidden mb-4">
          <Sheet>
            <SheetTrigger asChild>
              <Button variant="outline" className="w-full flex items-center justify-center gap-2 text-primary border-primary/70 hover:bg-primary/10 hover:text-primary font-semibold py-3 rounded-lg">
                <Filter className="w-5 h-5 text-primary" />
                Filters & Sort
              </Button>
            </SheetTrigger>
            <SheetContent side="bottom" className="p-4 bg-card border-t border-border text-foreground rounded-t-xl max-h-[80vh] overflow-y-auto">
                 ...
                 <Collapsible open={isPopularFiltersOpen} onOpenChange={setIsPopularFiltersOpen} defaultOpen className="mb-4">
                    ...
                    <CollapsibleContent className="space-y-2.5 mt-2.5 animate-slide-down">
                        ...
                        <div key={`stop-mobile-${stop}`} className="flex items-center gap-2.5">
                            ...
                            />
                            <label htmlFor={`stop-filter-mobile-${stop}`} className="text-xs font-medium text-foreground hover:text-foreground/80 transition-colors cursor-pointer">
                        ...
                        {[
                            ...
                            {key: "otherSort", label: "Other Sort", icon: MoreHorizontal}
                             ...
                             className={cn("text-xs h-auto py-1.5 px-2.5 flex-col items-center justify-center h-16", 
                                activeSortTab === tab.key ? "bg-orange-500 text-white border-orange-500" : "border-border text-foreground hover:bg-muted"
                             )}>
        ...
        <main className="flex-1">
          ...
          <div className="hidden lg:flex items-stretch gap-1 mb-5 p-1 bg-muted/50 rounded-lg shadow-sm">
            {[
              ...
              <Button
                ...
                className={cn("text-xs font-medium h-auto py-2 px-3 rounded-md flex flex-col items-center justify-center flex-1 text-center",
                  activeSortTab === tab.key ? "bg-orange-500 text-white shadow-sm" : "text-foreground hover:bg-muted hover:text-foreground"
                )}
              >
          ...
          <div className="mb-4 p-2 bg-primary/10 border border-primary/20 rounded-md text-center">
          ...
          <div className="space-y-4">
            {currentFlightsToDisplay.map((flight) => {
                ...
                <Card
                  ...
                  className={cn(
                    "overflow-hidden shadow-lg hover:shadow-xl transition-shadow duration-200 bg-card border-border text-foreground"
                  )}
                  role="region"
                  ...
                  <CardContent className="p-3 md:p-4">
                      <div className="mb-0 last:mb-0">
                            ...
                            <div className="flex-grow flex flex-col items-center justify-center px-2 min-w-[80px] md:min-w-[100px]">
                                ...
                                <div className="w-full h-px bg-border relative my-1">
                                    {itinerary.segments.length -1 > 0 && Array.from({length: itinerary.segments.length -1}).map((_,i) => (
                                        <div key={i} className="absolute h-1.5 w-1.5 bg-muted-foreground/70 rounded-full top-1/2 -translate-y-1/2" style={{left: `${(i+1) * (100/(itinerary.segments.length))}%`}}></div>
                                    ))}
                                </div>
                        ...
                        <div className="mt-2 text-center">
                            <p className="text-xs text-primary bg-primary/10 p-1.5 rounded-md">
      ...
      <footer className="mt-12 py-8 bg-muted/50 text-center text-muted-foreground border-t border-border">
...
Make this page as it is design no other thing