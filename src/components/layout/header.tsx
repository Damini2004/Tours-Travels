...
import {
  PlaneIcon, HotelIcon, LogInIcon, UserPlusIcon, HeartIcon, ListChecksIcon, LogOutIcon, UserCircle, BriefcaseIcon, LayoutDashboard, ListOrdered, DollarSign, LineChart
} from 'lucide-react';
...
export function Header() {
  ...
  // Effect to re-check localStorage if route changes (e.g., after login/signup redirect)
  useEffect(() => {
    ...
    // Re-check on mount and after navigation
    handleRouteChange(); 
  }, [router]);
